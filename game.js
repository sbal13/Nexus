...
class Game {
  ...
  constructor(teamID) {
    ...
    this.wsc = new WSClient(this.board, this.writeTile.bind(this), this)
    this.teamID = teamID
    this.HTTPConn = new HTTPConn(this.prepareBoard.bind(this), this.teamID)
  ...
  reconnectWS(timeout){
    Promise.resolve()
    .then(()=> {
      this.wsc = new WSClient(this.board, this.writeTile.bind(this), this, timeout+1000)
    })
    .then(() => {
      this.HTTPConn.getBoard()
    })
